...
if length(unique([vesnum vesnum2 ])) > 1
    waitbar(0,f,sprintf('VESSEL MATCH ERROR: Object, vessel, and/or distance transform data are from different vesels (Volume: Vessel %d Vessel: Vessel %d)',vesnum, vesnum2));
