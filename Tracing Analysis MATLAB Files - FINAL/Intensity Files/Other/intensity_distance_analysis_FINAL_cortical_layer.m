...
vessel_folder = 'C:\Users\exx\Desktop\Zach - Active Analysis\Human2267\Vessel_coord';
...
%%
figure()
scatter3(Tau_data(1:5:end,1),Tau_data(1:5:end,2),Tau_data(1:5:end,3),'MarkerFaceAlpha',0.1,'MarkerEdgeAlpha',0.1);
hold on
