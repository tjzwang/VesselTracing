...
% ENSURE INPUT FILES IN FOLDERS FOLLOW THE FORM: Human####_Vessel_##_DataType

%% IMPORT DATA/SETTINGS

% TAU INTENSITY COORDINATES:

tau_folder = 'C:\Users\zh624\Desktop\AD Blood Vessel Tracing\Human2302\Tau_Coord';

% VESSEL DISTANCE TRANSFORM COORDINATES:

distance_folder = 'C:\Users\zh624\Desktop\AD Blood Vessel Tracing\Human2302\DT_Coord';

% VESSEL DATA COORDINATES:

vessel_folder = 'C:\Users\zh624\Desktop\AD Blood Vessel Tracing\Human2302\Vessel_Coord';
...
fcontent2 = dir(fullfile(vessel_folder, '*.txt')); %fcontent is a column vector of structures
...
if length(unique([vesnum vesnum2 vesnum3])) > 1
