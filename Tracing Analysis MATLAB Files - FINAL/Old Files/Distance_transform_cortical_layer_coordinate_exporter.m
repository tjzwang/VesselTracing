...
% Column:     1  2  3      4             5
%           [ X  Y  Z   Distance   CorticalLayer]

%% IMPORT DATA/SETTINGS

% DISTANCE TRANSFORM Images (must be .tif):

distance_folder = 'C:\Users\exx\Desktop\Zach - Active Analysis\2131\2131 Transform Tiffs';

% Cortical Layer File:

cortical_file = 'C:\Users\exx\Desktop\Zach - Active Analysis\2131\Human2131_layers.tif';
...
folder_dir = 'C:\Users\exx\Desktop\Zach - Active Analysis\2131\Transform_cortical_coordinates';
...
distance_data = zeros(length(x),5);

[r,c,t] = size(distance_image);

parfor i = 1:length(x)
distance_data(i,:) = [x(i) y(i) z(i) distance_image(y(i),x(i),z(i)) cortical_image(y(i),x(i),z(i))];
end
...
txt_name = append(folder_dir,'/',new_name,'_DT_CORTICAL_COORD','.txt');
xlsx_name = append(folder_dir,'/',new_name,'_DT_CORTICAL_COORD', '.xlsx');
