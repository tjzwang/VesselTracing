...
sourcefolder = 'C:\Users\zh624\Desktop\AD Blood Vessel Tracing\Human2131\Intensity_distance_data_test';
...
% All data or single vessel? (0 = all, 1 = single)

vesnum = 1;

% Data Output Name (True, unshuffled data only) (Include Name + Path):
%Folder:
outputfoldername = 'C:\Users\zh624\Desktop\AD Blood Vessel Tracing\Human2131\Stat_data_imp_fit';
%File:
outputname = 'Human2131_percentage';
...
outputname = append(outputname,sprintf('%g',b));


writematrix(xdata,append(outputfoldername,'_xdata','\',outputname,'_stat_xdata'));
writematrix(ydata,append(outputfoldername,'_ydata','\',outputname,'_stat_ydata'));
writematrix(errors,append(outputfoldername,'_errors','\',outputname,'_stat_errors'));
