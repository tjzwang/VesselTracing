...
sourcefolder = '/Users/zacharyhoglund/Desktop/Arivis/Human2131/MATLAB Test Cortex Output';
...
group_Tau_data = [group_Tau_data(:,1:6) bin zeros(length(bin),1) zeros(length(bin),1) zeros(length(bin),1) Tau_data(:,11)];
