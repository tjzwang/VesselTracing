...
sourcefolder = '/Users/zacharyhoglund/Desktop/Zach - Files/Hyman Lab Work Files/BloodVesselTracing/Stat Analysis Data';
...
% convert bin numbers to true standard deviation
bin_numbers = cell2mat(sim_bin_data_comb(:,2));
bin_numbers = [(bin_numbers - 9.5)/2];

% run ANOVA for distance from vessel vs. intensity for each group down the
