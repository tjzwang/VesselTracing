...
tau_folder = '/Users/zacharyhoglund/Desktop/Arivis/Human2131/Tau Res 3';

% DISTANCE TRANSFORMS:

distance_folder = '/Users/zacharyhoglund/Desktop/Arivis/Human2131/Distance Coord Res 3';

% VESSEL DATA:

vessel_folder = '/Users/zacharyhoglund/Desktop/Arivis/Human2131/Vessel Coord Res 3';
...
% Save final data? What Format? Yes = [1]  No = [0]  (.txt is recommended)
...
folder_dir = '/Users/zacharyhoglund/Desktop/Arivis/Human2131/MATLAB Test Output';
...
final_name =  'MATLAB_Test_out_data_vessel' ;
...
f = waitbar(0,f,'Reading Tau Data');
...
f = waitbar(0,f,'Reading Distance Data');
...
f = waitbar(0,f,'Reading Vessel Data');
...
f = waitbar(0,f,'Getting Statistics for Vessel 1');
k = length(fcontent);
...
% % for i = 1:n
% % 
% % dist_sim = Distance_data;
% %   
% % idx = dist_sim(:,1) ~= new_Tau_data(i,1);
% % 
% % dist_sim(idx,:) = [];
% % 
% % idx = dist_sim(:,2) ~= new_Tau_data(i,2);
% % 
% % dist_sim(idx,:) = [];
% % 
% % idx = dist_sim(:,3) ~= new_Tau_data(i,3);
% % 
% % dist_sim(idx,:) = [];
% % 
% % new_Tau_data(i,6) = dist_sim(:,4);
% % 
% % end
...
x_fit = ((min(vessel_data(:,1))-minx-100):(max(vessel_data(:,1))-minx+100))';
y_fit = fxy(x_fit);
z_fit = fxz(x_fit);
